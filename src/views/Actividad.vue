  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Registre si el enunciado es verdadero o falso, según su grado de conocimiento frente al tema
        p.mb-4 Reconocer los conceptos y la relación que existe para las micro y pequeñas empresas y su normativa tributaria.
        .tarjeta.p-3
